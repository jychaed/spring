...
<body>
	<h2>MODIFY</h2>
	<form:form modelAttribute="item" action="/item2/modify" method="post" enctype="multipart/form-data">
		...
		<table>
			...
			<tr>
				<td>현재 파일</td>
				<td>
					<img src="/item2/display?itemId=${item.itemId }" width="210" height="240"/> <!-- 여기경로를 이어줘서 item/display 에 itemId가지고 컨트롤러로 넘어가  -->
				</td>
			</tr>
			<tr>
				<td>파일</td>
			...
			<tr>
				<td>현재 파일</td>
				<td>
					<img src="/item2/display2?itemId=${item.itemId }" width="210" height="240"/> <!-- 여기경로를 이어줘서 item/display 에 itemId가지고 컨트롤러로 넘어가  -->
				</td>
			</tr>
			<tr>
				<td>파일</td>
